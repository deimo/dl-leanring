import sys
import os
# 将项目根目录添加到系统路径中，以便能够导入 common 模块
...
optimizers["Adam"] = Adam(lr=0.5, alpha1=0.5, alpha2=0.999)

idx = 1

# 遍历优化器，用优化器更新参数，求解最小值点
for key in optimizers.keys():
    optimazer = optimizers[key]
    # 记录参数定的更新历史
    x_history = []
    y_history = []
    # 参数初始化
